...
// Function AnimBP_CampSimple.AnimBP_CampSimple_C.AnimNotify_OnLoopAnimStart
// (BlueprintCallable, BlueprintEvent)

void UAnimBP_CampSimple_C::AnimNotify_OnLoopAnimStart()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AnimBP_CampSimple_C", "AnimNotify_OnLoopAnimStart");
