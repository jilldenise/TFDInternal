...
// Parameters:
// bool                                    Set_Visible                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UUI_Game_InvasionDungeon_TimeAttack_C::UISet_Default(bool Set_Visible)
{
	...
	Params::UI_Game_InvasionDungeon_TimeAttack_C_UISet_Default Parms{};
...
void UUI_Game_InvasionDungeon_TimeAttack_C::BP_SetOpacityToOne(bool bVisible)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_Game_InvasionDungeon_TimeAttack_C", "BP_SetOpacityToOne");

	Params::UI_Game_InvasionDungeon_TimeAttack_C_BP_SetOpacityToOne Parms{};
