...
void UUI_GameCenter_Crosshair_C::BP_ChangedCrosshair(const bool bZoomed_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_GameCenter_Crosshair_C", "BP_ChangedCrosshair");

	Params::UI_GameCenter_Crosshair_C_BP_ChangedCrosshair Parms{};
