...
// WidgetBlueprintGeneratedClass UI_Button_Deco_Circle.UI_Button_Deco_Circle_C
// 0x0030 (0x0738 - 0x0708)
class UUI_Button_Deco_Circle_C final : public UM1UIButtonDeco
{
public:
...
public:
	void ExecuteUbergraph_UI_Button_Deco_Circle(int32 EntryPoint);
	void Construct();
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"UI_Button_Deco_Circle_C">();
	}
	static class UUI_Button_Deco_Circle_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UUI_Button_Deco_Circle_C>();
	}
};
