...
public:
	...
	bool                                          CallFunc_DetermineRecoveryCoefficient_UseRecoveryCoefficient; // 0x0238(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EM1StatType                                   CallFunc_DetermineRecoveryCoefficient_TakeRecoveryCoefficient; // 0x0239(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EM1StatType                                   CallFunc_DetermineRecoveryCoefficient_GiveRecoveryCoefficient; // 0x023A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FM1ScaledInteger                       CallFunc_ScaledIntegerOne_ReturnValue;             // 0x03A8(0x0008)(NoDestructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Conv_TextToString_ReturnValue;            // 0x03B0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	struct FM1ScaledInteger                       CallFunc_ScaledIntegerMax_ReturnValue;             // 0x03C0(0x0008)(NoDestructor, HasGetValueTypeHash)
};
