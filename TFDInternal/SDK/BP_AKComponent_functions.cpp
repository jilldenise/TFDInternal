...
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
// struct FTransform                       TargetTransform                                        (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_AKComponent_C::BP_OnTrapHit(const struct FTransform& TargetTransform)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_AKComponent_C_BP_OnTrapHit Parms{};
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// class UAkAudioEvent*                    InSectionEvent                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UBP_AKComponent_C::BP_OnTrapSectionStarted(class UAkAudioEvent* InSectionEvent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AKComponent_C", "BP_OnTrapSectionStarted");

	Params::BP_AKComponent_C_BP_OnTrapSectionStarted Parms{};

	Parms.InSectionEvent = InSectionEvent;
