...
public:
	...
	int32                                         K2Node_Event_InIndex;                              // 0x000C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// 0x0004 (0x0004 - 0x0000)
struct UI_Game_Radar_Icon_C_BP_SetSquadIndex final
{
public:
