...
// Function UI_GameHP_Named.UI_GameHP_Named_C.BP_RefreshWidgetImpl
// (Event, Protected, BlueprintEvent)

void UUI_GameHP_Named_C::BP_RefreshWidgetImpl()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_GameHP_Named_C", "BP_RefreshWidgetImpl");
...
void UUI_GameHP_Named_C::BP_InitBossMonsterWidget(bool bUseBerserkMode)
{
	static class UFunction* Func = nullptr;
	...
	Params::UI_GameHP_Named_C_BP_InitBossMonsterWidget Parms{};
