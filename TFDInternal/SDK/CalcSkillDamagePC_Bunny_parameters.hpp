...
public:
	...
	struct FM1ScaledInteger                       CallFunc_DetermineGaugeStatMultiplier_Bunny_AddPowerValue; // 0x0150(0x0008)(NoDestructor, HasGetValueTypeHash)
	struct FM1ScaledInteger                       CallFunc_DetermineGaugeStatMultiplier_Bunny_AddAttackValue; // 0x0158(0x0008)(NoDestructor, HasGetValueTypeHash)
