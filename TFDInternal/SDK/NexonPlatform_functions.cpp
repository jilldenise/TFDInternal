...
void UNXPShowCartDialogInterface::FailCommerceService(const class FString& Param)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NXPShowCartDialogInterface", "failCommerceService");

	Params::NXPShowCartDialogInterface_FailCommerceService Parms{};
...
void UNXPShowCartDialogInterface::SuccessCommerceService(const class FString& Param)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NXPShowCartDialogInterface", "successCommerceService");

	Params::NXPShowCartDialogInterface_SuccessCommerceService Parms{};
...
// Function NexonPlatform.NXPSurveyInterface.getUniqueID
// (Final, Native, Public)

void UNXPSurveyInterface::GetUniqueID()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NXPSurveyInterface", "getUniqueID");
