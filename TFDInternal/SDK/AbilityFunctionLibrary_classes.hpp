...
public:
	...
	static void FindFloorAtLocation(const struct FVector& TargetLocation2D, const struct FVector& InstigatorLocation, class UObject* __WorldContext, struct FVector* OutLocation);
	...
	static void CheckSpawnPoint(const struct FVector& SpawnLocation, const struct FVector& PivotLocation, double MinRadius, bool bLimitedSight, class AM1Monster* OwnerMonster, class UObject* __WorldContext, bool* Success);
	static void CheckSpawnedCount(TArray<class AM1Monster*>& InSpawnedMonsters, int32 MonsterCount, int32 LimitedSpawnedCount, class UObject* __WorldContext, bool* bCanSpawn);
	...
	static void CalcPivotLocation(class AActor* OwnerActor, double MinPivotForwardDistance, double MaxPivotForwardDistance, class UObject* __WorldContext, struct FVector* PivotLocation);
	static void AttatchArcheShield(const struct FVector& SpawnLocation, class UObject* __WorldContext);
