...
struct CalcPerkDamageRatio_C_DoCalculation final
{
public:
	...
	float                                         CallFunc_Conv_ScaledIntToFloat_ReturnValue;        // 0x0158(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_FromFloat_InValue_ImplicitCast;           // 0x0290(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
